document.addEventListener('DOMContentLoaded', function () {
    ...
    function openPopup(dateStr){
        ...
        const detailsDiv = document.querySelector('.popup-content .details');
        ...
        if(selectedActivityId){
            ...
            if(activity){
                ...
                details.innerHTML=`
                    ...
                    ${activity.image ? `<p><strong>Photo :</strong><br><img src="${activity.image}" style="max-width:150px;cursor:pointer;border-radius:6px;" onclick="window.open('${activity.image}','_blank')">` : ''}
                `;
    ...
    function markDays(){
        ...
        tds.forEach(td=>{
            ...
            td.style.backgroundColor=''; td.style.color=''; td.style.borderRadius=''; td.title='';
